...
const PaginatorResourceStringsPL_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsPL = PaginatorResourceStringsPL_ as ExpandRequire<IPaginatorResourceStrings>;
