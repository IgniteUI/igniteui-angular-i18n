...
const PaginatorResourceStringsRO_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsRO = PaginatorResourceStringsRO_ as ExpandRequire<IPaginatorResourceStrings>;
