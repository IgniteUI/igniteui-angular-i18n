...
const TimePickerResourceStringsSV_: ExpandRequire<ITimePickerResourceStrings> = {
 ...
 */
export const TimePickerResourceStringsSV = TimePickerResourceStringsSV_ as ExpandRequire<ITimePickerResourceStrings>;
