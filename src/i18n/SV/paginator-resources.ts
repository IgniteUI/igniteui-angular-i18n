...
const PaginatorResourceStringsSV_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsSV = PaginatorResourceStringsSV_ as ExpandRequire<IPaginatorResourceStrings>;
