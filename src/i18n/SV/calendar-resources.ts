...
const CalendarResourceStringsSV_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsSV = CalendarResourceStringsSV_ as ExpandRequire<ICalendarResourceStrings>;
