...
const ListResourceStringsIT_: ExpandRequire<IListResourceStrings> = {
 ...
 */
export const ListResourceStringsIT = ListResourceStringsIT_ as ExpandRequire<IListResourceStrings>;
