...
export const GridResourceStringsJA: IGridResourceStrings = {
    ...
    igx_grid_advanced_filter_title: '高度なフィルタリング',
    igx_grid_advanced_filter_and_group: '"および" グループ',
    igx_grid_advanced_filter_or_group: '"または" グループ',
    igx_grid_advanced_filter_end_group: '終了グループ',
    igx_grid_advanced_filter_create_and_group: '"および" グループの作成',
    igx_grid_advanced_filter_create_or_group: '"または" グループの作成',
    igx_grid_advanced_filter_and_label: 'および',
    igx_grid_advanced_filter_or_label: 'または',
    ...
    igx_grid_advanced_filter_initial_text: '"および"あるいは"または"にリンクされた条件のグループの作成から始めます。',
