...
const PaginatorResourceStringsFR_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsFR = PaginatorResourceStringsFR_ as ExpandRequire<IPaginatorResourceStrings>;
