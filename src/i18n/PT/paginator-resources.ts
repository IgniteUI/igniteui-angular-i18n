...
const PaginatorResourceStringsPT_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsPT = PaginatorResourceStringsPT_ as ExpandRequire<IPaginatorResourceStrings>;
