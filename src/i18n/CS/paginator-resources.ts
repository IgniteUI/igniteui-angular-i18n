...
const PaginatorResourceStringsCS_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsCS = PaginatorResourceStringsCS_ as ExpandRequire<IPaginatorResourceStrings>;
