...
const PaginatorResourceStringsHU_: ExpandRequire<IPaginatorResourceStrings> = {
 ...
 */
export const PaginatorResourceStringsHU = PaginatorResourceStringsHU_ as ExpandRequire<IPaginatorResourceStrings>;
