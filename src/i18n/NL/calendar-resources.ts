...
const CalendarResourceStringsNL_: ExpandRequire<ICalendarResourceStrings> = {
 ...
 */
export const CalendarResourceStringsNL = CalendarResourceStringsNL_ as ExpandRequire<ICalendarResourceStrings>;
